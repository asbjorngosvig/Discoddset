...
export function CategoryForm() {
  ...
  return (
    <form key={formKey} action={handleSubmit} className="rounded-xl border border-felt-700 bg-felt-900 p-4">
      <div className="flex gap-2">
        <input
          name="name"
          placeholder="Ny kategori, fx Øl-maraton"
          required
        ...
        >
          {isPending ? "Tilføjer…" : "Tilføj kategori"}
        </button>
      </div>
